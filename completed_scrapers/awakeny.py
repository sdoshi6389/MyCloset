"""Awake NY scraper — standard Shopify products.json via browser-context fetch.
Color is a proper named variant option ("Color"), no tag-matching needed.
"""
import sys, os
...
TABLE = "products_awakeny"
BASE  = "https://awakenyclothing.com"
LIMIT = 250
...
def main():
    p(f"Awake NY scraper -> table: {TABLE}")
    ensure_table(TABLE)
