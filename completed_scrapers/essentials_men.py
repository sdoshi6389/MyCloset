...
TABLE = "products_essentials_mens"

def get_all_page_links(page, base_url="https://fearofgod.com/collections/essentials-men"):
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # Load first page
        base_url = "https://fearofgod.com/collections/essentials-men"
