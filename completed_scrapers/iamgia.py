"""IAMGIA scraper — Shopify products.json via browser context."""
import sys, os, json
...
TABLE = "products_iamgia"
BASE = "https://www.iamgia.com"
LIMIT = 250
...
def parse_products(raw_products):
    ...
    for prod in raw_products:
        ...
        # Title format: "STYLE - COLOR" (each color is its own product)
        if ' - ' in full_title:
